...
export default function Home() {
  const naturopathy = [
  {
    ...
    title: "Hydrotherapy",
    answer:
      "Water-based treatments to improve circulation, relax muscles, and cleanse the body.",
  },
  {
    image: "https://cdn-icons-png.flaticon.com/256/4856/4856946.png",
    title: "Mud Therapy",
    answer:
      "Natural mud application to reduce inflammation, soothe skin, and aid detox.",
  },
  {
    image: "https://trendphysio.com/assets/png/x-Massage-Therapy.png",
    title: "Herbal Bath",
    answer:
      "Warm herbal baths to relax muscles, improve blood flow, and ease joint pain.",
  },
  {
    image: "https://cdn-icons-png.flaticon.com/256/12024/12024705.png",
    title: "Nutrition Guidance",
    answer:
      "Personalized natural diet plans to support digestion, immunity, and wellness.",
  },
  {
    image: "https://cdn-icons-png.freepik.com/256/5418/5418643.png",
    title: "Acupressure",
    answer:
      "Pressure-based therapy to relieve pain, balance energy, and support healing.",
  },
  {
    image:
    ...
    answer:
      "Plant-based remedies to restore balance and strengthen natural immunity.",
  },
];
  ...
  {
    title: "Nasal Therapy",
    description: "Nasal treatment to clear sinuses and calm the mind.",
    image: "./ayurvedaImage/nasya.webp",
  },
  {
    title: "Oil Intake Therapy",
    description: "Internal oil therapy to prepare the body for detox.",
  ...
  {
    title: "Herbal Steam",
    description: "Steam therapy to open pores and release toxins.",
    image: "./ayurvedaImage/Swedan.jpg",
  },
  {
    title: "Kapha Detox",
    description: "Therapy to remove excess Kapha from the body.",
    image: "./ayurvedaImage/Vaman.png",
  },
  {
    title: "Digestive Detox",
    description: "Purgation therapy for liver and digestive cleansing.",
    image: "./ayurvedaImage/Virechan.webp",
  },
  {
    title: "Colon Cleanse",
    description: "Medicated enema for deep colon detox.",
    image: "./ayurvedaImage/Vasti.jpg",
  },
  {
    title: "Mind Relaxation Therapy",
    description: "Warm oil therapy to calm the mind and nervous system.",
    image: "./ayurvedaImage/Shirodhara.png",
  },
  {
    title: "Pulse Diagnosis",
    description: "Pulse reading to assess body and mind balance.",
    image: "./ayurvedaImage/Nadiparikshan.jpg",
  },
  {
    title: "Ayurvedic Treatment",
    description: "Personalized medicines and therapies for healing.",
    image: "./ayurvedaImage/AyurvedicTreatment.jpg",
  },
  {
    title: "Pain Relief Therapy",
    description:
      "Fine-needle technique to relieve pain and improve energy flow.",
    image: "./ayurvedaImage/Viddhakarma.jpeg",
  },
  {
    title: "Heat Therapy",
    description:
      "Controlled heat treatment for chronic pain and inflammation.",
  ...
  return (
    <div className="w-full overflow-hidden">
      <div className="relative w-screen h-[calc(100vh-64px)] overflow-hidden">
        ...
        {/* Content Layer */}
        <div className="relative z-10 flex flex-col justify-center items-center gap-4 p-8 bg-black/70 w-full h-full">
          ...
          <div className="flex flex-col md:flex-row w-full items-center justify-center md:gap-3">
            <Link to="/program">
              <Button
                ...
                className="mt-4 w-full min-w-72 md:min-w-0"
                size="md"
                pill
              >
                Join Our Program
      ...
      <div className="container max-w-6xl mx-auto p-4 mt-4 bg-white bg-opacity-80 rounded">
        <h1 className="text-xl text-center font-bold py-8">Yoga Programs & Workshops</h1>
      ...
      <div className="border container max-w-6xl mx-auto my-4"></div>
      <div className="container max-w-6xl mx-auto p-4 bg-white/80 rounded">
        <h1 className="text-xl text-center font-bold">Naturopathy Theraphies</h1>
        <div className="flex flex-col justify-center items-center my-2 gap-4">
          ...
          <div className="grid gap-8 grid-cols-2 md:grid-cols-4 my-4">
      ...
      <div className="border container max-w-6xl mx-auto my-4"></div>
      <div className="container max-w-6xl mx-auto p-4 bg-white bg-opacity-80 rounded">
        <h1 className="text-xl text-center font-bold">Ayurveda & Holistic Wellness</h1>
        <div className="flex flex-col justify-center items-center my-4 gap-2">
          ...
          <p className="italic text-sm text-center">
            Natural healing for body, mind, and spirit.
          </p>
          <p className="font-semibold text-sm text-center">
            Our Core Therapies Include:
          </p>
          <div className="grid gap-8 grid-cols-2 md:grid-cols-4 my-4">
            {ayurvedaTherapies.map((item, index) => (
              <div key={index} className="flex flex-col items-center gap-2">
                <img
                  src={item.image}
                  className="w-32 rounded-2xl shadow-md aspect-square object-cover"
                  alt=""
                />
                <strong className="text-center">{item.title}</strong>
                <p className="text-xs text-center max-w-[40ch]">
      ...
      <div className="container max-w-6xl mx-auto p-4 bg-white bg-opacity-80 rounded">
        ...
        <div className="grid md:grid-cols-3 justify-center items-center my-6 gap-6">
      ...
      {/* ------------------  DOCTOR CONSULTANCY ---------------------- */}
      <div className="border container max-w-6xl mx-auto my-4"></div>
      <div className="container max-w-6xl p-4 mx-auto py-6 bg-white bg-opacity-80 rounded">
      ...
      <div className="p-4 container max-w-6xl mx-auto">
        <h1 className="container max-w-6xl mx-auto text-xl text-center pb-4 font-bold">
