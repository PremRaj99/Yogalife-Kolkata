  ...
  const naturopathy = [
    {
      ...
      title: "Hydrotherapy",
      answer:
        "Uses water treatments like baths and jets to boost circulation, relax muscles, and cleanse the body.",
    },
    {
      image: "https://cdn-icons-png.flaticon.com/256/4856/4856946.png",
      title: "Mud Therapy",
      answer:
        "Applies natural mud to reduce inflammation, soothe the skin, and support detoxification.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Offers personalized, natural diet plans to improve digestion, immunity, and overall wellness.",
    },
    {
      image: "https://cdn-icons-png.freepik.com/256/5418/5418643.png",
      title: "Acupressure & Reflexology",
      answer:
        "Stimulates key points in the body to relieve pain, improve energy flow, and support healing.",
    },
    {
      image:
      ...
      answer:
        "Uses safe, plant-based remedies to enhance organ function, restore balance, and boost natural immunity.",
    },
  ];
